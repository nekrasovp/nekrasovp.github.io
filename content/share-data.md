...
* [What you should deliver to the statistician](#what-you-should-deliver-to-the-statistician)
    ...
    - [The instruction list/script](#the-instruction-list/script)
* [What you should expect from the analyst](#what-you-should-expect-from-the-analyst)

## Abstract

This is a guide for anyone who needs to share data with a statistician or data scientist. 
The target audiences I have in mind are:
...
* The un formatted Excel file with 10 worksheets the company you contracted with sent you
...
1. Step 3 - take column three of outputfile.out for each sample and that is the corresponding
 row in the output data set
